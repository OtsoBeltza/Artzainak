...
document.addEventListener('DOMContentLoaded', function() {
    ...
    ctaElement.innerHTML = `
        <div class="fixed bottom-6 right-6 z-50 flex flex-col items-end space-y-3">
            ...
            <div id="floating-actions" class="flex flex-col items-end space-y-2 scale-0 opacity-0 transform origin-bottom-right transition-all duration-300">
                <a href="reservation.html" class="bg-primary hover:bg-primary-dark text-white !opacity-100 rounded-full p-3 shadow-lg flex items-center transition-all duration-300 w-12 h-12 hover:w-auto group">
                ...
                <a href="location.html" class="bg-forest hover:bg-forest/80 text-white !opacity-100 rounded-full p-3 shadow-lg flex items-center transition-all duration-300 w-12 h-12 hover:w-auto group">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="tel:+33608919431" class="bg-accent hover:bg-accent/80 text-primary !opacity-100 rounded-full p-3 shadow-lg flex items-center transition-all duration-300 w-12 h-12 hover:w-auto group">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button id="floating-toggle" class="bg-primary hover:bg-primary-dark text-white !opacity-100 rounded-full p-4 shadow-lg transition-all duration-300 focus:outline-none flex items-center justify-center">
    ...
    // Style supplémentaire pour forcer l'opacité, au cas où il y aurait des conflits CSS
    ...
    style.textContent = `
        ...
        #floating-toggle {
            background-color: #284533 !important;
        }
        #floating-actions a[href="reservation.html"] {
            background-color: #284533 !important;
        }
        #floating-actions a[href="location.html"] {
            background-color: #3A614A !important;
        }
        #floating-actions a[href^="tel:"] {
            background-color: #fff1d2 !important;
            color: #284533 !important;
        }
    `;
