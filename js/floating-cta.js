    ...
    ctaElement.innerHTML = `
        <div class="fixed bottom-6 right-6 z-50 flex flex-col items-end space-y-3">
            ...
            <div id="floating-actions" class="flex flex-col items-end space-y-2 scale-0 opacity-0 transform origin-bottom-right transition-all duration-300">
                ...
                <a href="location.html" class="bg-forest hover:bg-forest/80 text-white rounded-full p-3 shadow-lg flex items-center transition-all duration-300 w-12 h-12 hover:w-auto group">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="tel:+33608919431" class="bg-basque-red hover:bg-basque-red/80 text-white rounded-full p-3 shadow-lg flex items-center transition-all duration-300 w-12 h-12 hover:w-auto group">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
